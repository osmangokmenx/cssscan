...
.cssscan-button,
.cssscan-pinned-box,
#cssscan-eyedropper-buttons,
#cssscan-eyedropper-popup {
  z-index: 2147483647;
...
`;
    ...
    2: [
      function (require, module, exports) {
        ...
        const extension_styles = require("./license-modal-styles");

        const style_loader = document.createElement("style");
        style_loader.textContent = extension_styles;
        document.head.appendChild(style_loader);

        function addElement(parent, elementTag, elementId, html, attrClass) {
          var newElement = document.createElement(elementTag);
          newElement.setAttribute("id", elementId);
          attrClass && newElement.setAttribute("class", attrClass);
          newElement.innerHTML = html;
          parent.appendChild(newElement);
        }

        const modal = document.getElementById("cssscan-license-modal");
        if (!modal) {
          addElement(
            document.body,
            "div",
      ...
      <div id="cssscan-license-modal-content">
        ...
        <img src="${chrome.extension.getURL("icon.png")}" id="cssscan-license-modal-img">
        <h1 id="cssscan-license-modal-h1">CSS Scan - License check</h1>
        <div id="cssscan-license-modal-step-1">
          <p>Please check <a href="https://mycssscan.com" target="_blank">MyCssScan.com</a> or your receipt and enter your license key to continue:</p>
    ...
    `
          ...
          const licenseInput = document.getElementById("cssscan-license-input");
          window.onclick = function (event) {
            const licenseBtn = document.getElementById("cssscan-check-license-btn");
            if (event.target === licenseBtn && licenseInput.value.length > 20) {
              event.target.innerHTML = `<div class="cssscan-vertical-align"><img src="${chrome.extension.getURL(
                "spinner.svg"
              )}" width="15" class="cssscan-margin-right cssscan-spinner">Checking ...</div>`;
              event.target.disabled = true;
              chrome.runtime.sendMessage(
                { action: "validate_license", key: licenseInput.value.trim() },
                function (response) {}
              );
            }
            const closeBtn = document.getElementById("cssscan-license-modal-close");
            const modal = document.getElementById("cssscan-license-modal");
        ...
        chrome.runtime.onMessage.addListener(function (msg, sender, sendResponse) {
          const modal = document.getElementById("cssscan-license-modal");
          if (true === true) {
            //msg.text === //'are_you_there_content_script_modal?') {
          ...
          } else if (msg.text === "close_modal") {
            modal.style.display = "none";
          } else if (msg.text === "validate_result") {
            if (msg.valid) {
              document.getElementById("cssscan-license-modal-h1").innerText = "✅ Success!";
              document.getElementById("cssscan-license-modal-step-1").style.display = "none";
              document.getElementById("cssscan-license-modal-close").style.display = "none";
              setTimeout(() => {
                const modal = document.getElementById("cssscan-license-modal");
                modal.style.display = "none";
              }, 2000);
            } else {
              document.getElementById("cssscan-check-license-btn").disabled = false;
              document.getElementById("cssscan-check-license-btn").innerHTML = "Check again";
              alert(msg.alert);
            }
          }
          return true;
        ...
        document.onkeydown = function (e) {
          ...
          if (modal.style.display !== "none" && isEscape) {
            modal.style.display = "none";
          }
        };
      },
      { "./license-modal-styles": 1, axios: 3 },
    ],
    3: [
      function (require, module, exports) {
    ...
    4: [
      function (require, module, exports) {
        (function (process) {
          ...
          var btoa =
            (typeof window !== "undefined" && window.btoa && window.btoa.bind(window)) || require("./../helpers/btoa");
    ...
    9: [
      ...
      { "./../defaults": 16, "./../utils": 27, "./InterceptorManager": 10, "./dispatchRequest": 12 },
    ],
    10: [
      function (require, module, exports) {
        "use strict";
    ...
    16: [
      ...
      { "./adapters/http": 4, "./adapters/xhr": 4, "./helpers/normalizeHeaderName": 24, "./utils": 27, _process: 29 },
    ],
    17: [
      function (require, module, exports) {
        "use strict";
